...
def load_model():
    model=tf.keras.models.load_model('snake_clf_inceptionv3.h5')
    return model
...
button = st.button('About')
if button:
    st.text('created by Aditya Chache')
    st.write('[click here](https://github.com/adityachache/snake-species-classification) to go to the model training notebook')
